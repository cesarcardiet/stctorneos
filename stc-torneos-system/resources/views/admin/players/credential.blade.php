...
<head>
    ...
    <style>
        ...
        .credential-actions a, .credential-actions button { color: #00d5ff; background: none; border: 0; font-weight: 800; cursor: pointer; }
...
<body>
    <article class="credential-sheet">
        ...
        <div class="credential-actions">
            ...
            <a href="{{ route('admin.players.show', $player) }}">Volver</a>
        </div>
    </article>
</body>
</html>
